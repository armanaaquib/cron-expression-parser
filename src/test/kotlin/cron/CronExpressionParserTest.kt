...
internal class CronExpressionParserTest {
    ...
    @Nested
    @DisplayName("hour")
    inner class HourTest {
        private val hourErrorMessage =
            "Invalid hour field. Allowed values: 0–23 and Allowed special characters: * , - /"
    ...
    inner class MonthTest {
        private val monthErrorMessage =
            "Invalid month field. Allowed values: 1–12 and Allowed special characters: * , - /"
